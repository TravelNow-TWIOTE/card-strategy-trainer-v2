...
hand1.classList.remove("active")

if(active && activeHand===0){
...
hand2.classList.remove("active")

if(active && activeHand===1){
...
document.getElementById("msg").innerText = "Enter valid bet"
return
}
...
function floatMessage(text,color){

let msg = document.getElementById("msg")

msg.innerHTML = "<span class='float' style='color:"+color+"'>" + text + "</span>"
}
...
points -= wager
losses++
floatMessage("-"+wager,"red")
}
else if(dealerTotal > 21 || p > dealerTotal){
points += wager
wins++
floatMessage("+"+wager,"lightgreen")
}
